...
/** ✏️ 修改用户的默认对话参数 */
export const setUserChatParamsAPI = (params) =>
  apiRequest("post", "/user/setUserChatParams", { data: params });

/** ⚙️ 获得用户的默认对话参数 */
export const getUserChatParamsAPI = () =>
  apiRequest("get", "/user/getUserChatParams");

/** ✏️ 修改用户的默认配置 */
export const setUserSettingAPI = (params) =>
  apiRequest("post", "/user/setUserSetting", { data: params });
